import {TriangleMeshCharacterView} from "../CharacterNodes";
import {GameTerrainModel} from "./GameTerrainModel";
import {ATriangleMeshGraphic} from "../../../../anigraph";

/**
 * View designed to work with BotModel instances
 */
export class GameTerrainView extends TriangleMeshCharacterView {

  /**
   * Override model getter to interpret _model as a BotModel. This makes working with Typescript types easier.
   * @returns {GameTerrainModel}
   */
  get model(): GameTerrainModel {
    return this._model as GameTerrainModel;
  }
