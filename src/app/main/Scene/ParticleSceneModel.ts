...
import { BillboardParticle } from "../Nodes/BillboardParticleSystem/BillboardParticle";
...
export class MainSceneModel extends BaseSceneModel {
    ...
    particles!:BillboardParticleSystemModel
    ...
    async initScene() {
         ...
         */
        this.particles = new BillboardParticleSystemModel;

        /**
         * We will add the particle system to one of the bots for kicks...
         */
        this.bots[this.bots.length-1].addChild(this.particles);
